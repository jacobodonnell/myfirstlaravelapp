<div x-data="{ isOpen: false}">
    <button class="text-white mr-2 header-search-icon bg-transparent border-0 pe-auto" title="Search"
        data-toggle="tooltip" data-placement="bottom"
        x-on:click="isOpen = true; setTimeout(() => document.querySelector('#live-search-field').focus(), 200)">
