<div x-data="{isOpen: false}"">
    ...
    <div x-bind:class="isOpen ? 'chat--visible' : ''" data-username="{{auth()->user()->username}}"
        data-avatar="{{auth()->user()->avatar}}" id="chat-wrapper"
        class="chat-wrapper chat-wrapper--ready shadow border-top border-left border-right" style="display: flex">
        <div class="chat-title-bar">
            Chat <span x-on:click="isOpen = false" class="chat-title-bar-close">
